    ...
    <Box pb={12} px={5}>
      ...
      <Box mx="auto" className="container-xl" color="blue.2">
        <Flex flexWrap="wrap" mx={-5}>
          ...
          <Package icon={Ruby} href="https://github.com/primer/octicons/#ruby" title="Ruby docs">Install the Ruby gem, Rails helper, or Jekyll plugin to use in your project
          </Package>

          <Package
            icon={Paintcan}
            href="https://www.figma.com/file/FP7lqd1V00LUaT5zvdklkkZr/Octicons/duplicate" title="Open in Figma">Use SVG&#8217;s or Figma components in your design projects
          </Package>
        </Flex>
      </Box>
    </Box>
