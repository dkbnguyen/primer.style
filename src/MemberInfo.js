...
const MemberInfo = ({member}) => (
  <Box maxWidth="600px" id={member.handle}>
    <Text is="p" fontSize={4} mb={0} mt={0} color="blue.4">
    ...
    <Box mt={5}>
      <Text color="blue.3" fontWeight="bold" mr={1} fontSize={3} is="p">
    ...
    <Text color="blue.3" fontWeight="bold" is="p" fontSize={3} mt={4}>
    ...
    <Text color="blue.3" fontWeight="bold" mr={1} fontSize={3} mt={4}>
      Favorite tools:
    </Text>
    <Text fontSize={3}>
